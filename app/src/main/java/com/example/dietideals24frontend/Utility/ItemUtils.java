...
import com.example.dietideals24frontend.Controller.ItemController.Callback.ImageContentRequestCallback;
...
public class ItemUtils {
    ...
    public static void assignImageToItem(Item item, ItemController controller, ImageCallback callback) {
        int itemId = item.getItemId();
        String name = item.getName();
        controller.sendFindItemImageRequest(itemId, name, new ImageContentRequestCallback() {
            @Override
